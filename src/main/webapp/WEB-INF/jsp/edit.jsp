...
<html>
    ...
    <body>
        <div class="container">            
            <div class="row">
                <br>             
                <springForm:form class="form-horizontal" modelAttribute="studentToBeUpdated" role="form" action="${pageContext.servletContext.contextPath}/edit">
                    <fieldset>
                        <legend class="text-primary">Information Update</legend>
